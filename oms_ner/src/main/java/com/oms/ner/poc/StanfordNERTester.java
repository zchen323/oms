...
// this is to test if NER will work in the project space
public class StanfordNERTester {
	...
	*/
	...
	{
		String content="Sachin Ramesh Tendulkar (Listeni/ˌsətʃɪn tɛnˈdu�?lkər/; Marathi: "
		+ " सचिन रमेश तेंड�?लकर; born 24 April 1973) is an Indian former cricketer widely "
